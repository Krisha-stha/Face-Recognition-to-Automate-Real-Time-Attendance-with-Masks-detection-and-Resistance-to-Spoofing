...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        button = Button(bg_image,image=self.studentphoto, cursor="hand2")
        button.place(x=200, y=100, width=220, height=220)

        button1 = Button(bg_image,text="Student Details", cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "pink")
        ...
        button = Button(bg_image,image=self.attend, cursor="hand2")
        button.place(x=800, y=100, width=220, height=220)

        button3 = Button(bg_image,text="Attendance", cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "pink")
        ...
        button = Button(bg_image,image=self.helppp, cursor="hand2")
        button.place(x=1100, y=100, width=220, height=220)

        button4 = Button(bg_image,text="Help", cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "pink")
        ...
        button = Button(bg_image,image=self.trainn, cursor="hand2")
        button.place(x=200, y=380, width=220, height=220)

        button4 = Button(bg_image,text="Train", cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "pink")
        ...
        button = Button(bg_image,image=self.develop, cursor="hand2")
        button.place(x=800, y=380, width=220, height=220)

        button4 = Button(bg_image,text="Developer", cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "pink")
        ...
        button = Button(bg_image,image=self.exit, cursor="hand2")
