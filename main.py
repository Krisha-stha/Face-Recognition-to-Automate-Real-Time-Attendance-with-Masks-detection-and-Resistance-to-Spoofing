...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # background image
        img3 = Image.open(r"my_images\image2.jpeg")
        ...
        title_lbl = Label(bg_image, text = "FACE RECOGNITION ATTENDANCE SYSTEM", font = ("Calibri", 35, "bold"),bg = "white", fg = "#191970")
        title_lbl.place(x = 0, y = 0, width = 1530, height = 45)

        # student Details
        student = Image.open(r"my_images\studentdetails.jpeg")
        ...
        button1 = Button(bg_image,text="Student Details",command=self.student_details, cursor="hand2", font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        ...
        button2 = Button(bg_image,text="Face Detector", cursor="hand2", command=self.face_data,font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        ...
        button3 = Button(bg_image,text="Attendance", cursor="hand2", command=self.attendance_data, font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        button3.place(x=800, y=300, width=220, height=40)

        # Help button
        helpme = Image.open(r"my_images\help1.jpeg")
        ...
        button4 = Button(bg_image,text="Help", cursor="hand2", command=self.help, font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        button4.place(x=1100, y=300, width=220, height=40)

        #train
        trainn = Image.open(r"my_images\train.jpeg")
        ...
        button4 = Button(bg_image,text="Train", cursor="hand2", command=self.train_data, font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        ...
        button4 = Button(bg_image,text="Photos", cursor="hand2", command=self.open_img, font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        button4.place(x=500, y=580, width=220, height=40)

        #develop
        developer = Image.open(r"my_images\developer.jpeg")
        ...
        button4 = Button(bg_image,text="Developer", cursor="hand2", command = self.developer_data,font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
        ...
        button4 = Button(bg_image,text="Exit", cursor="hand2", command=self.iExit,font = ("times new roman", 15, "bold"),bg = "white", fg = "#191970")
