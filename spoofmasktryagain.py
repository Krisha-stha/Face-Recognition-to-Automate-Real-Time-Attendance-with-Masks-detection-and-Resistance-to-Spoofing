    ...
    def face_recog(self):
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                if mask_pred < 0.5:  # Mask detected
                    cv2.rectangle(img, (x, y), (x+w, y+h), (0, 255, 255), 3)  # Yellow for mask
                    cv2.putText(img, "Please remove your mask", (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
                    continue  # Skip recognition if mask is detected
                
                # If no mask, proceed with original recognition flow
